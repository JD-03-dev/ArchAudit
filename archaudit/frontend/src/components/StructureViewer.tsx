...
const TreeNode: React.FC<TreeNodeProps> = ({
  ...
  if (isFile) {
    return (
      <div
        className={cn(
          "flex items-center py-1.5 hover:bg-white/5 rounded-lg px-2 cursor-default transition-colors group",
          statusColor,
        )}
  ...
  return (
    <div>
      <div
        className={cn(
          "flex items-center py-1.5 hover:bg-white/5 rounded-lg px-2 cursor-pointer group transition-colors",
          statusColor,
        )}
          ...
          {Object.entries(data)
            ...
            .map(([childName, childData]) => (
              <TreeNode
                ...
                improvedStructure={
                  improvedStructure
                    ? typeof improvedStructure[name] === "object"
                      ? improvedStructure[name]
                      : undefined
                    : undefined
                }
              />
